...
class FakeWeatherDataGenerator:
    def __init__(
        ...
        transparency_range=(
            fields.Transparency.LOW_BOUND,
            fields.Transparency.HIGH_BOUND,
        ),
        ...
        prec_types=tuple(fields.Prec),
        wind10m_directions=tuple(fields.WindDirection),
        ...
        self.timepoints = sorted(
            [
                self.fake.unique.date_time_between(
                    start_date=self.tomorrow, end_date=self.three_days_from_now
                )
    ...
    def produce_data(self):
        ...
        return [
            _produce_random_measures(location=location, timepoint=timepoint)
